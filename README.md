...
```
Here ***DataPubTest*** publish command and state of motor and power of the robot, where for now the values are assigned with constant initial values and increasing with constant increments for each publish.  
