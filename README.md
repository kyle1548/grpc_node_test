...
```
Here ***DataPubTest*** publish command/state of motor/power of the robot, where for now the values are assigned with constant initial values and increase with constant increments after each publish.  
